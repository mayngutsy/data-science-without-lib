class Chart{
   ...
   showDynamicPoint(points,label,nearestSamples){
      this.dynamicPoints={points,label};
   ...
   #draw(){
      ...
      if(this.dynamicPoints){
         const {points,label}=this.dynamicPoints;
